...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zhouxingbo/PodDemo'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zhouxingbo' => '973984457@qq.com' }
  s.source           = { :git => 'https://github.com/zhouxingbo/PodDemo.git', :tag => s.version.to_s }
